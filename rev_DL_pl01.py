...
with tab1_1:
    ...
    with col1:
        ...
        fig1 = px.bar(points_reset, x="Piloto", y="Pontos", text="Pontos") #, title="Top 10 Pilotos com Mais Pontos"
        fig1.update_layout(xaxis_title="Piloto", yaxis_title="Total de Pontos", uniformtext_minsize=8, uniformtext_mode='hide') #title_x=0.5, 
...
with tab1_2:
    ...
    with col1:
        ...
        fig2.update_layout(xaxis_title="Piloto", yaxis_title="Total de vitórias", uniformtext_minsize=8, uniformtext_mode='hide') # title_x=0.5, 
...
with tab2_1:
    ...
    with col1:
        ...
        fig3.update_layout(xaxis_title="Piloto", yaxis_title="Total de pontos", uniformtext_minsize=8, uniformtext_mode='hide')
...
with tab2_2:
    ...
    with col1:
        ...
        fig4.update_layout(xaxis_title="Equipas", yaxis_title="Total de vitórias", uniformtext_minsize=8, uniformtext_mode='hide')
...
with tab3:
    ...
    with col1:
        ...
        fig5.update_layout(xaxis_title="Resultado", yaxis_title="Número de Corridas", uniformtext_minsize=8, uniformtext_mode='hide') # title_x=0.5, 
...
with tab4_1:
    ...
    with col1:
        ...
        fig6.update_layout(xaxis_title="Circuito", yaxis_title="Número de Abandonos", uniformtext_minsize=8, uniformtext_mode='hide')
...
with tab4_2:
    ...
    with col1:
        ...
        fig7.update_layout(xaxis_title="Piloto", yaxis_title="Número de Abandonos", uniformtext_minsize=8, uniformtext_mode='hide')
...
with tab6:
    ...
    with col1:
        ...
        fig9.update_layout(xaxis_title="Piloto", yaxis_title="Mediana de pontos", uniformtext_minsize=8, uniformtext_mode='hide')
